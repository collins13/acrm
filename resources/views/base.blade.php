...
<head>
	...
	<link rel="stylesheet" href="{{ asset('base/assets/css/atlantis.min.css')}}">
...
<body>
	...
	<!--   Core JS Files   -->
	<script src="{{ asset('base/assets/js/core/jquery.3.2.1.min.js')}}"></script>
	<script src="{{ asset('base/assets/js/core/popper.min.js')}}"></script>
	<script src="{{ asset('base/assets/js/core/bootstrap.min.js')}}"></script>

	<!-- jQuery UI -->
	<script src="{{ asset('base/assets/js/plugin/jquery-ui-1.12.1.custom/jquery-ui.min.js')}}"></script>
	<script src="{{ asset('base/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js')}}"></script>
	...
	<!-- jQuery Vector Maps -->
	<script src="{{ asset('base/assets/js/plugin/jqvmap/jquery.vmap.min.js')}}"></script>
	<script src="{{ asset('base/assets/js/plugin/jqvmap/maps/jquery.vmap.world.js')}}"></script>

	<!-- Sweet Alert -->
	<script src="{{ asset('base/assets/js/plugin/sweetalert/sweetalert.min.js')}}"></script>

	<!-- Atlantis JS -->
	<script src="{{ asset('base/assets/js/atlantis.min.js')}}"></script>
