		                ...
		                <div class="row align-items-center">
		                    ...
		                    <div class="col-md-3">
		                        <div class="header-logo">
		                            <a href="index.html"><img src="img/logo/logo.png" alt="CHURCH APP"></a>
		                        </div>
		                    </div>
		                    <!--Header Logo End-->
		                    <!--Header Menu Start-->
		                    <div class="col-md-9">
		                        <div class="header-menu-area text-right navbar-dark fixed-top bg-light ">
		                            <nav>
		                                <ul class="main-menu">
		            ...
		            <div class="row align-items-center">
		                <div class="col-md-8 col-xl-6">
		                    <div class="hero-content">
		                        <div class="title">
		                            <h1>AFRICA FOR CHRIST RADIO MINISTRIES</h1>
		                            <h2>Expert Broadcasters</h2>
		                        </div>
		                        <div class="description">
		                           <p>
								   we provide Christ centered free consultancy and guidance services to all Christian organizations and 
								   individual Christians who have been called to establish Radio stations for Africa.
		                ...
		                <div class="col-md-4 col-xl-6">
		                    <div class="hero-img img-full mt-30" data-wow-duration="1.5s" style="visibility: visible; animation-duration: 1.5s; animation-name: fadeInUp;">
		                        <img src="/img/WhatsApp Image 2020-02-09 at 9.41.40 AM.jpeg" alt="">
		                    </div>
		                </div>
		            </div>
		        </div>
		        ...
		        <div class="row  align-items-center">
		            <div class="col-md-4">
		                ...
		                <div class="section-title feature-section-title">
                            <h2>Our <br> <span>Vision</span></h2>
                            <p>
							Africa is largely unentered and the large population is unreached by the gospel of Christ. The same population needs soul nurturing through continuous broadcasts and besides the gospel the population need constant teachings and educational programs through radio broadcasts addressing the issues of
							</p>
		                </div>
		                <!--Section Title End-->
		            </div>
		                ...
		                <div class="row">
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>Public health</h2>
                                    <p>including sound sanitation and hygiene, </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    ...
                                    <p> prevention of diseases and continuous awareness.  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                    <div class="col-md-6">
		                        <!--Single Feature Start-->
		                        <div class="single-feature">
                                    <h2>News dissemination and entertainment for the public good.
</h2>
		    ...
		    <div class="container">
		        <div class="row  align-items-center">
		            <div class="col-md-4">
                        <!--Section Title Start-->
		                <div class="section-title feature-section-title">
                            <h2>Our <br> <span>TARGET</span></h2>
                            <p>
							We are looking at those Christ centered organizations, Christian churches, individual  men and women of high calling 
							</p>
		                </div>
		                <!--Section Title End-->
		            </div>
		            <div class="col-md-8">
		                <div class="row">
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>a)</h2>
                                    <p>Ready to establish FM Radio stations in their region for the above mission only </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2> b)</h2>
                                    <p> Ready to establish Sound Broadcast Terminal (SDT) in their region for the above mission only  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    ...
                                    <p>Ready and willing to support any of the above project either in their village or far away region.</p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                </div>
		    ...
		    <div class="container">
		        <div class="row  align-items-center">
		            <div class="col-md-4">
                        <!--Section Title Start-->
		                <div class="section-title feature-section-title">
                            <h2>Our <br> <span>OUR ROLE</span></h2>
                            <p>
							Above are our role for the organization
							</p>
		                </div>
		                <!--Section Title End-->
		            </div>
		            <div class="col-md-8">
		                <div class="row">
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>1.</h2>
                                    <p>We receive & process requests from allover Africa for FMs & SDTs </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2> 2.</h2>
                                    <p> We identify and verify presented projects to determine their viability and sustainability to professional and technical standards for the interest of the targeted community.  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
		                    <div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>3.</h2>
                                    <p>We do site survey and acertain technical parameters, management, sustainability, local government licensing and we address any challenge pertaining to the a particular project.  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
							<div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>4.</h2>
                                    <p>We list all those projects for funding from within and without.  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
							<div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>5.</h2>
                                    <p>We implement those projects, commission them, train technical support stuff with terms and conditions of services and operation contract agreement entered into.  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
							...
							<div class="col-md-6">
		                        ...
		                        <div class="single-feature">
                                    <h2>6.</h2>
                                    <p> We periodically monitor the progress and operations of these stations and terminals.  </p>
		                        </div>
		                        <!--Single Feature End-->
		                    </div>
                    ...
                    <div class="col-12">
                        <div class="about-wrapper black-bg pt-110 pb-110">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="about-img">
                                        <!-- <img src="/img/WhatsApp Image 2020-01-31 at 9.00.10 AM.jpeg" alt=""> -->
                                ...
                                <div class="col-md-7">
                                    <div class="about-content">
                                        ...
                                        <h1>Hay! HERE IS AFRICA FOR CHRIST RADIO MINISTRIES</h1>
                                        <h5>Professional & Experienced Broadcasters</h5>
                                        <p>
										We are a Broadcasting & Transmission Engineers. we work with international christian TV stations and radio stations. we travel a lot around Africa installing  over 32 FM stations for SDA Church.
										 </p>
		    ...
		    <div class="container">
		        <div class="row">
		            <div class="col-md-6 col-lg-4">
		                ...
		                <div class="single-timeline mb-50 d-flex align-items-center">
		                    <div class="timeline-frame">
		                        <h3>2010<span>5th Jan</span></h3>
		                    </div>
		                    <div class="timeline-content">
		                        <h4>Start THE ORAGNIZATION</h4>
		            ...
		            <div class="col-md-6 col-lg-4">
		                ...
		                <div class="single-timeline mb-50 d-flex align-items-center">
		                    <div class="timeline-frame">
		                        <h3>2011 <span>10th Feb</span></h3>
		                    </div>
		                    <div class="timeline-content">
		                        <h4>Best broadca services</h4>
		                        <!-- <p>voluptatum deleniti atque uos es et quas molestias cepte</p> -->
		                    </div>
		                </div>
		                <!--Single Timeline End-->
		            ...
		            <div class="col-md-6 col-lg-4">
		                ...
		                <div class="single-timeline mb-50 d-flex align-items-center">
		                    <div class="timeline-frame">
		                        <h3>2020<span>22 Aug</span></h3>
		                    </div>
		                    <div class="timeline-content">
		                        <h4>Beinstalled over 40</h4>
		                        <!-- <p>voluptatum deleniti atque uos es et quas molestias cepte</p> -->
		                    </div>
		                </div>
		                <!--Single Timeline End-->
		        ...
		        <div class="row align-items-center">
		            <div class="col-12 col-lg-4">
		                <div class="service-img">
		                    <img src="/img/service-png-2.png" alt="">
		                </div>
		            </div>
		                        ...
		                        <div class="row">
		                            ...
		                            <div class="col-md-6">
		                                <div class="single-service mb-60 d-flex flex-nowrap">
		                                    ...
		                                    <div class="service-content">
		                                        <h4><a href="single-service.html">Broadcasting</a></h4>
		                            ...
		                            <div class="col-md-6">
		                                <div class="single-service mb-60 d-flex flex-nowrap">
		                                    ...
		                                    <div class="service-content">
		                                        <h4><a href="single-service.html">Installation</a></h4>
		                                        <!-- <p>voluptatum deleniti atque corrupti is es et quas molestias cepturi sint aete non provident, similique sunt </p> -->
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="col-md-6">
		                                <div class="single-service mb-60 d-flex flex-nowrap">
		                                    ...
		                                    <div class="service-content">
		                                        <h4><a href="single-service.html">Corporate installation</a></h4>
		                                        <!-- <p>voluptatum deleniti atque corrupti is es et quas molestias cepturi sint aete non provident, similique sunt </p> -->
		                                    </div>
		                                </div>
		                            </div>
		                            ...
		                            <div class="col-md-6">
		                                <div class="single-service mb-60 d-flex flex-nowrap">
		                                    ...
		                                    <div class="service-content">
		                                        <h4><a href="single-service.html">Ministries</a></h4>
		                                        <!-- <p>voluptatum deleniti atque corrupti is es et quas molestias cepturi sint aete non provident, similique sunt </p> -->
		                                    </div>
		                                </div>
		                            </div>
		            ...
		            <div class="col-md-12">
                        ...
                        <div class="section-title text-center mb-70">
                           <img src="img/icon/icon1.png" alt="">
                            <h4>blog</h4>
                            <h2>Latest Blog</h2>
                            <!-- <p>Find the stories and actities about us for more details informations to ge to know us better</p> -->
                        </div>
                        <!--Section Title End-->
		            </div>
		        </div>
		    ...
		    <div class="footer-container">
		                ...
		                <div class="row">
		                    <div class="col-md-6 col-lg-3">
		                        ...
		                        <div class="single-footer-widget mb-30">
									...
									<h1 href="#">kistec</h1>
		                            <p>Please enter ur email to subscribe to daily new letter</p>
		        ...
		        <div class="footer-bottom-area pt-20 pb-20">
		            <div class="container text-center">
		               <p><span>&copy;</span> Copyright, 2020 All right reserved by <a href="#">AFRICA FOR CHRIST RADIO MINISTRIES</a></p>
		            </div>
		        </div>
