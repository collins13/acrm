      ...
      <div class="container">
        ...
        {{-- <div class="row no-gutters">
          ...
          <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up">
            <span>01</span>
            <h6>Our Vision</h6>
			<p>Africa is largely unentered and the large population is unreached by the gospel of Christ. The same population needs soul nurturing through continuous broadcasts and besides the gospel the population need constant teachings and educational programs through radio broadcasts addressing the issues of</p>
			<br>
			<h6>Public health</h6>
			...
			<br>
			<h6>News dissemination and entertainment for the public good.
			</h6>
          ...
          <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="100">
            <span>02</span>
            <h6>TARGET</h6>
			<p>We are looking at those Christ centered organizations, Christian churches, individual  men and women of high calling </p>
			<br>
			<p>a) Ready to establish FM Radio stations in their region for the above mission only </p>
			<br>
			<p>b) Ready to establish Sound Broadcast Terminal (SDT) in their region for the above mission only  </p>
			<br>
			<p>c) Ready and willing to support any of the above project either in their village or far away region.</p>
          </div>

          <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="200">
            <span>03</span>
            <h6> OUR ROLE</h6>
			<p>Above are our role for the organization.</p>
			<br>
			<p>1)We receive & process requests from allover Africa for FMs & SDTs </p>
			<br>
			<p> 2)We identify and verify presented projects to determine their viability and sustainability to professional and technical standards for the interest of the targeted community.  </p>
          ...
          <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="400">
            <span>05</span>
            <h6>Sapiente Magnam</h6>
            <p>Vitae dolorem in deleniti ipsum omnis tempore voluptatem. Qui possimus est repellendus est quibusdam</p>
          </div>

          <div class="col-lg-4 col-md-6 content-item" data-aos="fade-up" data-aos-delay="500">
            <span>06</span>
            <h6>Facilis Impedit</h6>
...
<hr><br>
      ...
      <div class="container">
        ...
        <div class="row  d-flex align-items-stretch">
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="100">
            <h6>Feugiat scelerisque varius morbi enim nunc faucibus a pellentesque?</h6>
            <p>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="200">
            <h6>Dolor sit amet consectetur adipiscing elit pellentesque habitant morbi?</h6>
            <p>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="300">
            <h6>Ac odio tempor orci dapibus. Aliquam eleifend mi in nulla?</h6>
            <p>
              Dolor sit amet consectetur adipiscing elit pellentesque habitant morbi. Id interdum velit laoreet id donec ultrices. Fringilla phasellus faucibus scelerisque eleifend donec pretium. Est pellentesque elit ullamcorper dignissim.
            </p>
          </div>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="400">
            <h6>Tempus quam pellentesque nec nam aliquam sem et tortor consequat?</h6>
            <p>
          ...
          <div class="col-lg-6 faq-item" data-aos="fade-up" data-aos-delay="500">
            <h6>Tortor vitae purus faucibus ornare. Varius vel pharetra vel turpis nunc eget lorem dolor?</h6>
            <p>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>ACRM</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
